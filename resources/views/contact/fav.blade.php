...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between border-left-info">
        <h6 class="m-0 font-weight-bold text-primary">Favourite Contact List ({{ $contacts->count() }})</h6>
    </div>
    <!-- Card Body -->
    <div id="">
        @forelse ($contacts as $contact)
        <hr class="contact-ruller">
        <div class="d-flex align-items-center justify-content-between head-contact-div">
